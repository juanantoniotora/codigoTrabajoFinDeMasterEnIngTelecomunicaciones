...
public class UsuariosEntity {
     ...
     */
    public UsuariosEntity id(Long id) {
        setId(id);
        return this;
    }
     ...
     */
    public UsuariosEntity ilusion(String aficion) {
        setAficion(aficion);
        return this;
    }
    ...
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof UsuariosEntity)) {
            return false;
        }
        UsuariosEntity tora = (UsuariosEntity) o;
        return Objects.equals(id, tora.id) && Objects.equals(aficion, tora.aficion);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, aficion);
    }
